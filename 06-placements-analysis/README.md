...
`MASTER DATA/` here is synthetic sample data (fake names, emails, and reg numbers), matching the schema the app expects. The original files held real classmates' academic and contact records and were removed from this repo's entire history — not just deleted, purged from every commit.
